# Install kubernetes 1.35 on ubuntu 24.04
...
```bash
kubeadm init --control-plane-endpoint 192.168.122.11 --apiserver-advertise-address=192.168.122.11 --pod-network-cidr=192.168.0.0/16 -v5
```
